using Aerolineas.DataStorage.Contexts;
...
namespace Aerolineas.DataStorage.Repositories
{
    public class Repository<TEntity> : IRepository<TEntity> where TEntity : class
    {
        ...
        private AerolineasDbContext<TEntity> DbContext
        {
            get
            {
                var dbContext = _ambientDbContextLocator.Get<AerolineasDbContext<TEntity>>();
